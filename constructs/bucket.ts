...
export class GraaspS3Bucket extends Construct {
  ...
  constructor(scope: Construct, name: string, website: boolean, customCors: S3BucketCorsConfigurationCorsRule[] = [], bucketOwnership: S3BucketObjectOwnership = "ObjectWriter") {
    super(scope, name);
